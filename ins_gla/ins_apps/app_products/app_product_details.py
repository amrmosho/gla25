...
class AppProductDetails(App):
    ...
    ## Images Container
        ...
        uidata.append({"_data": "E£ 208,750.00", "class": "ins-col-6  ins-grey-d-color ins-title-xs ins-strong-l ins-flex-end "})
        uidata.append({"_data": "Making Charge + VAT", "class": "ins-col-6  ins-title-xs  ins-grey-color  ins-strong-m"})
        uidata.append({"_data": "EGP 1,960.00", "class": "ins-col-6  ins-grey-d-color ins-title-xs ins-strong-l ins-flex-end"})
        ...
        uidata.append({"_data": "E£ 208,750.00", "class": "ins-col-6  ins-strong-l ins-flex-end ins-title-20	 ins-primary-d-color"})
        vat = "59.60"
        uidata.append({"_data": "Note: Vat amount is " + "<spam class='ins-grey-d-color'> EGP "+vat+"</span>", "class": "ins-col-6 ins-grey-color ins-strong-m ins-title-14"})
        uidata.append({"end": "true"})
