...
class AppCal(App):
    ...
    def ui_body(self, total):
        ...
        uidata += body
        product = self.search(total, {"f": 1, "t": 3})
        ...
        summary = [
            {"end": "true"},
            {"start": "true", "class": "ins-primary-w ins-padding-l ins-flex ins-gap-o",
                "style": "width:360px"},
            {"_data": "Item summary",
                "class": "ins-col-12 ins-font-m ins-grey-d-color ins-strong-l"},
            {"class": "ins-space-xl"},
            {"_data": "3 x Gold bar 10G",
                "class": "ins-col-6 ins-strong-m ins-grey-color"},
            {"_data": "E£ 208,750.00",
                "class": "ins-col-6  ins-grey-d-color ins-strong-l ins-flex-end"},
            {"class": "ins-space-s"},
            {"class": "ins-line ins-col-12"},
            {"class": "ins-space-s"},
            ...
            {"_data": "E£ 208,750.00",
                "class": "ins-col-6  ins-grey-d-color ins-strong-l ins-flex-end"},
            {"class": "ins-space-2xl"},
            {"_data": "ADD TO CART <i class = 'lni lni-arrow-right ins-white-color'></i>", "class": "ins-col-12 ins-button-s ins-flex-center  ins-white-color ins-strong-m ins-gold-d -add-cart-btn",
                "style": "    height: 32px;    border: 1px solid var(--primary-d);font-size:14px;"},
            {"end": "true"},
            {"end": "true"},
            {"end": "true"},
            {"end": "true"}
        ...
        body = [
            ...
            {"start": "true", "class": " ins-flex ins-padding-xl  ins-col-12"},
            {"_data": " 4 - 9 items",
                "class": "ins-font-l ins-strong-l  ins-grey-d-color"},
            {"class": "ins-line ins-col-12"},
            {"start": "true", "class": " ins-radius-l ins-border ins-col-12 ins-flex",
                "style": "overflow: hidden;"},
            {"start": "true", "class": "  ins-col-grow ins-padding-xl ins-flex"},
        ...
        uidata += body
        product = self.search(total, {"f": 4, "t": 9})
        for k, pro in product.items():
        ...
        uidata += body
        product = self.search(total, {"f": 10, "t": 24})
        for k, pro in product.items():
            products = [
                {"start": "true", "style": "width:210px"},
                {"start": "true", "class": " product-img-cont ", "style": ""},
