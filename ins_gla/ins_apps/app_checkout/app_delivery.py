...
class AppDelivery(App):
    ...
    def _store_area_ui(self,string=True):
        ...
        for a in stores:
           ...
           uidata.append({"start":"true","data-aid":a["id"],"data-type":"store","class":"ins-col-12 ins-card ins-flex-valign-center -address-btn ins-padding-s -address-cont","style":"    line-height: 20px;"})
    ...
    def ui(self):
      ...
      ## Addresses Area
        ...
        atype_btns= [{"_data": f"<img class='-address-type-radio-btn' src= {p}style/radio_checked.svg></img> {delivery_text}", "data-type":"delivery","class": f"ins-button-s ins-text ins-col-6  ins-m-col-6  ins-gold-bg ins-flex-center -delivery-type-btn ins-strong-m ins-gold-bg"},
                {"_data": f"<img class='-address-type-radio-btn' src= {p}style/radio.svg></img> {store_text}","data-type":"store","class": f"ins-button-s  ins-col-6 ins-flex ins-flex-center   ins-m-col-6   -delivery-type-btn ins-strong-m inactive insactive"}
                ]
        if type(asession) == dict and "type" in asession and  asession["type"] == "store":
         atype_btns= [{"_data": f"<img class='-address-type-radio-btn' src= {p}style/radio.svg></img> {delivery_text}", "data-type":"delivery","class": f"ins-button-s ins-text ins-col-6 ins-m-col-6 ins-flex-center -delivery-type-btn ins-strong-m inactive"},
                {"_data": f"<img class='-address-type-radio-btn' src= {p}style/radio_checked.svg ></img>{store_text}","data-type":"store","class": f"ins-button-s  ins-col-6 ins-flex ins-flex-center  ins-m-col-6 -delivery-type-btn ins-strong-m  ins-gold-bg"}
                ]
        ...
        uidata.append({"class":"ins-space-xl not-for-web"})
        uidata.append({"class":"ins-line ins-col-12 not-for-web"})
        uidata.append({"class":"ins-space-xl not-for-web"})
        uidata.append({"class":"ins-space-xl not-for-web"})
