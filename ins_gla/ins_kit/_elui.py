...
class ELUI(ins_parent):
    ...
    def cart_pro_block(self,data,string=False):
        ...
        uidata = [
            ...
            {"_data": f"<i  class='lni lni-trash-3 _a_red'></i>","class": "ins-flex-center ins-col-1 -remove-item-side-cart-btn", "data-pid": data["id"]},
    ...
    def counter_pro_block(self,  data, string=False):
        ...
        uidata = [
            ...
            {"_type": "input",  "name": "count_inpt", "type": "text",
                "value": data["count"], "pclass": "ins-col-4 ", "data-pid":data["id"],"class": "count-inpt ins-title-xs ins-strong-l"},
