...
class AppTest(App):
    ...
    def out(self):
        ...
        <script type="importmap">
            ...
            <span id="centerBtn"  title='Settings'  style='background-image: url(/ins_web/ins_images/icons/gear-1.svg);'></span>
            <span id="" title='Helap'  style='background-image: url(/ins_web/ins_images/icons/question-mark-circle.svg);'></span>
            </div>
                
                
                <div  class='insv-animation-cont insv-flex ins-panel'>
                    ...
                    <div style="width:100%"></div>
                              <span id="playAnimBtn" title='Play' class='insv-icon_btn' style='background-image: url(/ins_web/ins_images/icons/play.svg);'></span>
