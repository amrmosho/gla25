...
class AppUiGuideInputs(App):
    ...
    def out(self):
        ...
        uidata.append({"_data": f"> Input ", "id":"_input",  "class": "ins-col-12 ins-title-m  "})
        ...
        uidata.append( {"start": "true", "id":"_auto","class": "ins-col-12  ins-margin-xl ins-bg-4 ins-border ins-card  ins-flex "})
        uidata.append({"_data": f"> Auto ", "class": "ins-col-12 ins-title-m  "})
        ...
        uidata.append({"_data": f"> Select ", "id":"_select",  "class": "ins-col-12 ins-title-m  "})
        ...
        uidata.append({"end": "true"})
        uidata.append( {"start": "true", "class": "ins-col-12 ins-bg-4  ins-margin-xl ins-border ins-card  ins-flex "})
        uidata.append({"_data": f"> Upload ","id":"_upload",  "class": "ins-col-12 ins-title-m  "})
