from ins_admin.ins_apps.app_ui_guide.app_ui_guide_chart import AppUiGuideCharts
...
class AppUiGuide(App):
    ...
    def out(self):
        ...
        charts = {"_type": "a", "href": self.__url(
            "charts"), "_data": "<i class='  ins-link ins-flex-center ins-icons-bar-chart'> </i>Charts", "class": "ins-title-s ins-flex  ins-strong-l ins-padding-m ins-radius-xl"}
        ...
        elif "mode" in g and g["mode"] == "charts":
            r = AppUiGuideCharts(self.app).out()            
            
        header = [{"start": "true", "class": "ins-flex ins-col-grow"},
                  {"start": "true", "class": "ins-flex ins-col-12  "},icons, style, inputs, charts,test ]
        header.append(
